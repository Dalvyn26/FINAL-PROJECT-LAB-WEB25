    ...
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-sm text-slate-500 mt-1">Overview of your team's leave requests and activity</p>
            </div>
        </div>
    </x-slot>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                ...
                <div class="group bg-white/80 backdrop-blur-sm border border-[#E5E7EB] shadow-[0_1px_3px_0_rgba(0,0,0,0.05)] rounded-[20px] p-6 transition-all duration-300 hover:shadow-[0_4px_12px_0_rgba(0,0,0,0.08)] hover:-translate-y-1 relative overflow-hidden">
                    ...
                    <div class="flex items-center justify-between">
                        <div class="flex items-center gap-4">
                            <div class="p-4 rounded-2xl bg-indigo-50 shadow-sm">
                                <svg class="w-7 h-7 text-[#4F46E5]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <div>
                                ...
                                <p class="text-4xl font-bold text-slate-900 tracking-tight">{{ $totalRequests }}</p>
                ...
                <div class="group bg-white/80 backdrop-blur-sm border border-[#E5E7EB] shadow-[0_1px_3px_0_rgba(0,0,0,0.05)] rounded-[20px] p-6 transition-all duration-300 hover:shadow-[0_4px_12px_0_rgba(0,0,0,0.08)] hover:-translate-y-1 relative overflow-hidden">
                    ...
                    <div class="flex items-center justify-between mb-4">
                        <div class="flex items-center gap-4">
                            ...
                            <div>
                                <h3 class="text-sm font-medium text-[#6B7280] mb-1">Pending for Review</h3>
                                <p class="text-4xl font-bold text-amber-600 tracking-tight">{{ $pendingRequests }}</p>
                                <p class="text-xs text-[#6B7280] mt-1">Awaiting approval</p>
                            </div>
                        </div>
                    </div>
                    <a href="{{ route('leader.leave-requests.index') }}" 
                       class="inline-flex items-center gap-2 bg-gradient-to-r from-amber-500 to-orange-500 hover:from-amber-600 hover:to-orange-600 text-white text-sm font-semibold py-2.5 px-5 rounded-xl transition-all duration-300 hover:scale-105 hover:shadow-lg shadow-md">
                        Review Requests
            ...
            <div class="bg-white/80 backdrop-blur-sm border border-[#E5E7EB] shadow-[0_1px_3px_0_rgba(0,0,0,0.05)] rounded-[20px] p-6 mb-8 transition-all duration-300"
                ...
                <div class="flex items-center justify-between mb-6">
                    <div>
                        <h3 class="text-lg font-semibold text-slate-900 mb-1">Sedang Cuti Minggu Ini</h3>
                        <p class="text-sm text-[#6B7280]">Team members currently on leave</p>
                    </div>
                </div>
            ...
            <div class="bg-white/80 backdrop-blur-sm border border-[#E5E7EB] shadow-[0_1px_3px_0_rgba(0,0,0,0.05)] rounded-[20px] p-6 transition-all duration-300"
                ...
                <div class="flex items-center justify-between mb-6">
                    <div>
                        <h3 class="text-lg font-semibold text-slate-900 mb-1">Daftar Anggota Divisi</h3>
                        <p class="text-sm text-[#6B7280]">Complete team member list</p>
                    </div>
                </div>
