            ...
            <div class="flex-1 overflow-y-auto py-4">
                <nav class="space-y-1 px-2">
                    ...
                    @if(Auth::user()->role == 'admin')
                        ...
                        <!-- Leave Summary -->
                        <a href="{{ route('admin.leave-summary.index') }}"
                           @click="sidebarOpen = false"
                           class="group flex items-center px-4 py-2.5 text-sm font-medium rounded-xl transition-all duration-200 {{ request()->routeIs('admin.leave-summary.*') ? 'bg-indigo-50 text-indigo-600 shadow-sm' : 'text-slate-600 hover:bg-slate-50/80 hover:text-slate-900' }}">
                            <svg class="w-5 h-5 mr-3 transition-transform duration-200 {{ request()->routeIs('admin.leave-summary.*') ? 'scale-110' : 'group-hover:scale-110' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    @if(Auth::user()->role == 'division_leader')
                        ...
                        <a href="{{ route('leader.leave-requests.index') }}"
                           @click="sidebarOpen = false"
                           class="group flex items-center px-4 py-2.5 text-sm font-medium rounded-xl transition-all duration-200 {{ request()->routeIs('leader.leave-requests.index') ? 'bg-indigo-50 text-indigo-600 shadow-sm' : 'text-slate-600 hover:bg-slate-50/80 hover:text-slate-900' }}">
                            <svg class="w-5 h-5 mr-3 transition-transform duration-200 {{ request()->routeIs('leader.leave-requests.index') ? 'scale-110' : 'group-hover:scale-110' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <!-- Leave Summary -->
                        <a href="{{ route('leader.leave-summary.index') }}"
                           @click="sidebarOpen = false"
                           class="group flex items-center px-4 py-2.5 text-sm font-medium rounded-xl transition-all duration-200 {{ request()->routeIs('leader.leave-summary.*') ? 'bg-indigo-50 text-indigo-600 shadow-sm' : 'text-slate-600 hover:bg-slate-50/80 hover:text-slate-900' }}">
                            <svg class="w-5 h-5 mr-3 transition-transform duration-200 {{ request()->routeIs('leader.leave-summary.*') ? 'scale-110' : 'group-hover:scale-110' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path>
                            </svg>
                            Leave Summary
                        </a>
