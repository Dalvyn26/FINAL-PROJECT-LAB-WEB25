    ...
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-sm text-slate-500 mt-1">Overview of leave requests and team activity</p>
            </div>
        </div>
    </x-slot>
    ...
    <div class="py-8 bg-[#F8FAFC]" x-data="{ 
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8" 
                ...
                <div class="group bg-white/80 backdrop-blur-sm border border-[#E5E7EB] shadow-[0_1px_3px_0_rgba(0,0,0,0.05)] rounded-[20px] p-6 transition-all duration-300 hover:shadow-[0_4px_12px_0_rgba(0,0,0,0.08)] hover:-translate-y-1"
                    ...
                    <div class="flex items-center justify-between">
                        <div class="flex items-center gap-4">
                            <div class="p-4 rounded-2xl bg-gradient-to-br from-[#4F46E5] to-[#6366F1] shadow-lg shadow-indigo-500/20">
                            ...
                            <div>
                                <h3 class="text-sm font-medium text-[#6B7280] mb-1">Total Leave Requests</h3>
                                <p class="text-4xl font-bold text-slate-900 tracking-tight">{{ $totalLeavesThisMonth }}</p>
                ...
                <div class="group bg-gradient-to-br from-orange-500 to-amber-500 rounded-[20px] p-6 text-white shadow-lg shadow-orange-500/20 transition-all duration-300 hover:shadow-xl hover:shadow-orange-500/30 hover:-translate-y-1 hover:scale-[1.02]"
                    ...
                    <div class="flex items-center justify-between mb-4">
                        <div class="flex items-center gap-4">
                            ...
                            <div>
                                <h3 class="text-sm font-medium text-white/90 mb-1">Pending Final Approval</h3>
                                <p class="text-4xl font-bold text-white tracking-tight">{{ $pendingFinalApprovals }}</p>
                                <p class="text-xs text-white/80 mt-1">Awaiting review</p>
                            </div>
                        </div>
                    </div>
                    <a href="{{ route('hrd.leave-requests.index') }}" 
                       class="inline-flex items-center gap-2 bg-white/20 backdrop-blur-sm hover:bg-white/30 text-white text-sm font-semibold py-2.5 px-5 rounded-xl transition-all duration-300 hover:scale-105 hover:shadow-lg">
            ...
            <div class="bg-white/80 backdrop-blur-sm border border-[#E5E7EB] shadow-[0_1px_3px_0_rgba(0,0,0,0.05)] rounded-[20px] p-6 mb-8 transition-all duration-300"
                 x-show="mounted"
                ...
                <div class="flex items-center justify-between mb-6">
                    <div>
                        <h3 class="text-lg font-semibold text-slate-900 mb-1">Absensi Cuti Bulan Ini</h3>
                        <p class="text-sm text-[#6B7280]">Employees currently on leave</p>
                    </div>
                </div>
                ...
                @else
                    <div class="text-center py-12">
                        ...
                        <h3 class="text-base font-semibold text-slate-900 mb-1">Tidak ada karyawan cuti bulan ini</h3>
                        <p class="text-sm text-[#6B7280]">Tidak ada karyawan yang sedang cuti pada periode ini.</p>
                    </div>
                @endif
            </div>
            ...
            <div class="bg-white/80 backdrop-blur-sm border border-[#E5E7EB] shadow-[0_1px_3px_0_rgba(0,0,0,0.05)] rounded-[20px] p-6 transition-all duration-300"
                ...
                <div class="flex items-center justify-between mb-6">
                    <div>
                        <h3 class="text-lg font-semibold text-slate-900 mb-1">Overview Divisi</h3>
                        <p class="text-sm text-[#6B7280]">Division structure and team members</p>
                    </div>
                </div>
