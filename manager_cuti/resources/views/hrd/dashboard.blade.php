<x-app-layout>
    ...
    <div class="py-6 sm:py-8 bg-[#F8FAFC]" x-data="{ 
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <!-- Daftar Karyawan yang Sedang Cuti Bulan Ini (Ongoing/Inactive) -->
            <div class="bg-white/80 backdrop-blur-sm border border-[#E5E7EB] shadow-[0_1px_3px_0_rgba(0,0,0,0.05)] rounded-[20px] p-4 sm:p-6 transition-all duration-300 mb-6 sm:mb-8"
                ...
                <div class="flex items-center justify-between mb-4 sm:mb-6">
                    <div>
                        ...
                        <p class="text-xs sm:text-sm text-[#6B7280]">Daftar karyawan yang sedang dalam masa cuti (status inactive)</p>
                    </div>
                </div>
                
                @if($employeesCurrentlyOnLeave->count() > 0)
                    <!-- Desktop Table View -->
                        ...
                        <div class="inline-block min-w-full align-middle px-2">
                            <table class="min-w-full divide-y divide-[#E5E7EB]">
                                ...
                                <tbody class="bg-white divide-y divide-[#E5E7EB]">
                                    @foreach($employeesCurrentlyOnLeave as $leave)
                ...
                @else
                    <div class="text-center py-12">
                        ...
                        <p class="text-sm text-[#6B7280]">Tidak ada karyawan yang sedang dalam masa cuti saat ini.</p>
                    </div>
                @endif
            </div>

            <!-- Daftar Karyawan yang Cuti Bulan Ini -->
            <div class="bg-white/80 backdrop-blur-sm border border-[#E5E7EB] shadow-[0_1px_3px_0_rgba(0,0,0,0.05)] rounded-[20px] p-4 sm:p-6 transition-all duration-300 mb-6 sm:mb-8"
                 x-show="mounted"
                ...
                <div class="flex items-center justify-between mb-4 sm:mb-6">
                    <div>
                        <h3 class="text-base sm:text-lg font-semibold text-slate-900 mb-1">Karyawan yang Cuti Bulan Ini</h3>
                        <p class="text-xs sm:text-sm text-[#6B7280]">Daftar semua karyawan yang mengambil cuti di bulan {{ \Carbon\Carbon::now()->format('F Y') }}</p>
                    </div>
                </div>
